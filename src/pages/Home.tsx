...
const Home = () => {
  return (
    <div>
        ...
        <footer>
          <p>————</p>
          <p> Or, if you don't want to click on any of the links, here's a "recent" picture from my camera roll that I find cool (updated 7/2026):</p>
          <div className="flex justify-center">
            <img src="busan.jpeg" alt="busan" className="w-[70%]" loading="lazy" decoding="async" />
          </div>
